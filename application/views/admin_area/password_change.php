                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <label for="exampleInputEmail1">Userid</label>
                                                    <input type="text" class="form-control" id="userid" name="userid" autocomplete="off" placeholder="Userid"  value="">
                                            </div>
...
<script>
    $("#form").validate({ 
        rules:  {   userid: {   required: true,
                                remote  :{  url: "<?php echo site_url('check_user') ?>",
                                            type: "post"
                                         },                  
                            },              
        ...
        messages:   {  userid  :"&nbsp;Please enter Userid",
                       remote  : "&nbsp;Entered Userid is not registered ",
        ...
        submitHandler: function ()
        {
            ...
            $.ajax({
                    type: "POST",
                    url: "<?php echo site_url('reform_password') ?>",
