...
<button type="button" class="btn btn-success pull-right" onclick="add_attribute()"><i class="fa fa-plus"></i> Create New
          </button>
        </div>
        <div class="box-body">
              <div class="row">
...
<script>
  $(document).ready(function () {
    ...
    $('.sidebar-menu').tree();
		  ...
		  var  search=$("#search").val();	
	         $.ajax({
                type: "POST",
                url: "<?php echo site_url('attribute_list') ?>",
  ...
  {
	  window.location.href='<?php echo site_url('add_attribute')?>';
  }
  ...
  function applyPagination() {
        ...
        return false;
	     ...
	     function deactivate_attribute(id)
  {
            ...
            type: "POST",			  
            data:{id:id},
            url: '<?php echo site_url('admin_area/admin_area/deactivate_attribute') ?>',
            success: function(msg) {
		 	...
		 	if(msg=="success")
				...
				{
					//$("#id"+id).html("Error");
					  swal({title: "Error!", type: "eoor", text: "Error occurs", showConfirmButton: false, timer: 2000});
				}
            }
          });
  }
  
      function activate_attribute(id)
  {
            ...
            type: "POST",			  
            data:{id:id},
            url: '<?php echo site_url('admin_area/admin_area/activate_attribute') ?>',
            success: function(msg) {
