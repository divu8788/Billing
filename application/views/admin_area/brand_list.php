        ...
        <div class="col-xs-12">
          <div class="box">
			...
			<div class="col-md-4">
                  ...
                  <input type="text" class="form-control" required="" id="c_brand_name" name="c_brand_name" placeholder="Brand Name">
				   </div>
	     	<div class="col-md-4">
                  <label for="exampleInputEmail1">Image</label>
                  <input type="file" class="form-control" required="" id="c_brand_image" name="c_brand_image">
				   </div>
				  <div class="col-md-4">
				   <label for="add"></label>
...
<script>
  $(document).ready(function () {
	...
	$('.fancybox').fancybox();
		  ...
		  var  search=$("#search").val();	
	         $.ajax({
                type: "POST",
                url: "<?php echo site_url('brand_list') ?>",
    ...
    function deactivate_brand(id)
  {
            ...
            type: "POST",			  
            data:{id:id},
            url: '<?php echo site_url('admin_area/admin_area/deactivate_brand') ?>',
      ...
      function activate_brand(id)
  {
            ...
            type: "POST",			  
            data:{id:id},
            url: '<?php echo site_url('admin_area/admin_area/activate_brand') ?>',
            success: function(msg) {
...
<script>
 $("#categoryform").validate({
		      ...
		      if($("#categoryform").valid()){
				...
				url: "<?php echo site_url('brand_insert');?>",
				data: formData,
				processData: false,
				contentType: false,
				cache: false,
                ...
                success: function (msd)
						...
						$('#err_msgs').html("");
							  ...
							  swal({title: "Error!", type: "error", text: "Can't upload image..!", showConfirmButton: false, timer: 2000});
						$('#submit').attr('Disabled',false);
						$('#err_msgs').html("");
						   }
						   else{
